...
exports.exploreCategoriesById = async(req,res)=>{
    try {
        ...
        res.render('categories',{title:'Cooking Blog - Ctegories',categoryById})
...
exports.submitRecipe = async(req,res)=>{
    ...
    res.render('submit-recipe',{title:'Cooking Blog - Sumit recipe',infoErrorsObj,infoSubmitObj})
...
//     try {
//         const res = await Recipe.deleteOne({ name:''})
//         res.n //numer of documents matched
//         res.nModified
//     } catch (error) {
//         console.log(error)
//     }
